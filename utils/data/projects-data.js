...
export const projectsData = [
  ...
  },
  {
    ...
    name: "Poll App",
    description:
      "This app uses the tech stack React Native and Supabase. It is a polling app and uses anonymous logins to vote towards a particular topic or issue. A user can create a poll via logging in only. Only one anonymous login is created and you can't be creating new anonymous accounts each time to vote.",
